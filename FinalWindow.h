...
class FinalWindow{ 
public: 
    FinalWindow(unsigned int x, unsigned int y); 
...
private: 
    //This function just loads the text and all the graphics. The purpose is to divide the resposibility and neaten up code 
    void setUpWindow();  
    void loadText(); 
    // Hnadles user input 
